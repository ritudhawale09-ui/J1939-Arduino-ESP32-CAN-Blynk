...
## How to Run
1. Upload `Engine_ECU.ino` to the Arduino UNO  
2. Upload `Display_Node.ino` to the ESP32  
3. Connect MCP2515 modules to the CAN bus  
4. Configure Wi-Fi credentials and Blynk Auth Token  
5. Open Serial Monitor to verify CAN messages  
6. View live data on the Blynk dashboard
...
|-----|------|
| V0  | Engine Speed (RPM) |
| V1  | Vehicle Speed (km/h) |

---

## Learning Outcomes
- Practical experience with **CAN & J1939**
- ECU-to-ECU communication design
